...
class main:
    def __init__(self,master):
        ...
        self.frame = Frame(master, width=700, height=190, bg="black", highlightbackground="gold", highlightthickness=15)
        self.frame.place(x=50, y=10)
        self.frame_two = Frame(master, width=350, height=230, bg="black", highlightbackground="gold", highlightthickness=15)
        self.frame_two.place(x=50, y=185)
        self.frame_three = Frame(master, width=350, height=230, bg="black", highlightbackground="gold",highlightthickness=15)
        self.frame_three.place(x=400, y=185)
        self.frame_four = Frame(master, width=700, height=180, bg="black", highlightbackground="gold", highlightthickness=15)
        self.frame_four.place(x=50, y=400)
        ...
        self.match3.place(x=10, y=170)
        self.ent3_win = Label(self.frame_three, text="", bg="gold")
        self.ent3_win.place(x=130, y=170)
